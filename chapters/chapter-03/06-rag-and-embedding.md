...
上一章我们说：提示词技巧正在被模型内化，你不需要太操心。

但有两件事模型自己搞不定，需要你来设计：
- **知识从哪来**：模型不知道你的私有数据
- **上下文怎么组织**：找到了内容，怎么塞进去才有效

这一章解决这两个问题。我们先说第一个：**如何让模型"知道"它没见过的知识**。

---

模型的知识有边界——这一点我们在第一章讨论过。企业私有文档、最新 API、公司内部 Wiki，这些它没见过。
...
**这引出了下一课的核心问题**：RAG 解决了"怎么找到"，但没解决"怎么组织"。当你从海量数据中筛出了相关内容，接下来要面对的是——**有限的 context window，怎么装下最有价值的信息？**
...
**但筛出来之后呢？** 怎么确保模型真的"看到"并"用上"这些内容？这是下一课的主题。
