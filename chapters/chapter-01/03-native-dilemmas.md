...
| 边界 | 解决方案 |
|------|----------|
| In-Context Learning 不稳定 | **Prompt Engineering**：更精确地"说话" |
| 知识凝固 | **RAG / 长上下文**：外挂知识 |
| 上下文迷失 | **Context Engineering**：智能地组织输入 |
| 只能输出文本 | **Tool Calling / MCP**：让模型能调用函数 |
| 幻觉难消除 | **Harness Engineering**：构建约束和验证系统 |

这门课的后续结构，就是在逐一解决这些边界：
- 第二章：Prompt Engineering——学会更好地"说话"
- 第三章：RAG & Context Engineering——外挂知识、管理上下文
- 第四章：Tool Calling & MCP——让模型能"动手"
- 第五章：Harness Engineering——给模型装上"护栏"
